...
TEST_CASE("Tests to verify the calculate statistics") {
	...
	ExpectedChargeRate[NUMBER_OF_BATTERY][] = {{0.60,1.10,0.8},{0.00,1.20,0.94}};
	ExpectedTemperature[NUMBER_OF_BATTERY][] = {{5.00,45.00,15.80},{0.00,45.00,35.40}};
	ExpectedSOC[NUMBER_OF_BATTERY][] = {{20.00,45.00,15.80},{21.00,80.00,51.00}};
